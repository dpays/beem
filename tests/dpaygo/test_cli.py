...
from dpaygo.cli import cli, balance
...
class Testcases(unittest.TestCase):
    ...
    def test_balance(self):
        ...
        result = runner.invoke(cli, ['balance', 'dpaygo', 'dpaygo1'])
        self.assertEqual(result.exit_code, 0)

    def test_interest(self):
        runner = CliRunner()
        runner.invoke(cli, ['set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['interest', 'dpaygo', 'dpaygo1'])
        self.assertEqual(result.exit_code, 0)
    ...
    def test_info(self):
        ...
        self.assertEqual(result.exit_code, 0)
        result = runner.invoke(cli, ['info', 'dpaygo'])
        self.assertEqual(result.exit_code, 0)
    ...
    def test_transfer(self):
        runner = CliRunner()
        runner.invoke(cli, ['-o', 'set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['transfer', 'dpaygo1', '1', 'BBD', 'test'], input="test\n")
        self.assertEqual(result.exit_code, 0)

    def test_powerdownroute(self):
        runner = CliRunner()
        runner.invoke(cli, ['-o', 'set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['powerdownroute', 'dpaygo1'], input="test\n")
        self.assertEqual(result.exit_code, 0)
    ...
    def test_permissions(self):
        runner = CliRunner()
        runner.invoke(cli, ['-o', 'set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['permissions', 'dpaygo'])
        self.assertEqual(result.exit_code, 0)

    def test_follower(self):
        runner = CliRunner()
        runner.invoke(cli, ['-o', 'set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['follower', 'dpaygo1'])
        self.assertEqual(result.exit_code, 0)

    def test_following(self):
        runner = CliRunner()
        runner.invoke(cli, ['-o', 'set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['following', 'dpaygo'])
        self.assertEqual(result.exit_code, 0)

    def test_muter(self):
        runner = CliRunner()
        runner.invoke(cli, ['-o', 'set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['muter', 'dpaygo1'])
        self.assertEqual(result.exit_code, 0)

    def test_muting(self):
        runner = CliRunner()
        runner.invoke(cli, ['-o', 'set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['muting', 'dpaygo'])
        self.assertEqual(result.exit_code, 0)

    def test_allow_disallow(self):
        runner = CliRunner()
        runner.invoke(cli, ['-o', 'set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['-d', 'allow', '--account', 'dpaygo', '--permission', 'posting', 'dpaygo1'], input="test\n")
        self.assertEqual(result.exit_code, 0)
        result = runner.invoke(cli, ['-d', 'disallow', '--account', 'dpaygo', '--permission', 'posting', 'dpaygo1'], input="test\n")
        self.assertEqual(result.exit_code, 0)
    ...
    def test_approvewitness(self):
        runner = CliRunner()
        runner.invoke(cli, ['-o', 'set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['-o', 'approvewitness', 'dpaygo1'], input="test\n")
        self.assertEqual(result.exit_code, 0)

    def test_disapprovewitness(self):
        runner = CliRunner()
        runner.invoke(cli, ['-o', 'set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['-o', 'disapprovewitness', 'dpaygo1'], input="test\n")
        self.assertEqual(result.exit_code, 0)

    def test_newaccount(self):
        runner = CliRunner()
        runner.invoke(cli, ['-o', 'set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['-d', 'newaccount', 'dpaygo3'], input="test\ntest\ntest\n")
        self.assertEqual(result.exit_code, 0)
        result = runner.invoke(cli, ['-d', 'newaccount', '--fee', '6 BEX', 'dpaygo3'], input="test\ntest\ntest\n")
        self.assertEqual(result.exit_code, 0)

    def test_importaccount(self):
        runner = CliRunner()
        runner.invoke(cli, ['-o', 'set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['importaccount', '--roles', '["owner", "active", "posting", "memo"]', 'dpaygo2'], input="test\numybjvCafrt8LdoCjEimQiQ4\n")
        self.assertEqual(result.exit_code, 0)
    ...
    def test_follow_unfollow(self):
        runner = CliRunner()
        runner.invoke(cli, ['-o', 'set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['follow', 'dpaygo1'], input="test\n")
        self.assertEqual(result.exit_code, 0)
        result = runner.invoke(cli, ['unfollow', 'dpaygo1'], input="test\n")
        self.assertEqual(result.exit_code, 0)

    def test_mute_unmute(self):
        runner = CliRunner()
        runner.invoke(cli, ['-o', 'set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['mute', 'dpaygo1'], input="test\n")
        self.assertEqual(result.exit_code, 0)
        result = runner.invoke(cli, ['unfollow', 'dpaygo1'], input="test\n")
        self.assertEqual(result.exit_code, 0)
    ...
    def test_witnesscreate(self):
        runner = CliRunner()
        runner.invoke(cli, ['-o', 'set', 'nodes', str(self.nodelist.get_testnet())])
        result = runner.invoke(cli, ['-d', 'witnesscreate', 'dpaygo', pub_key], input="test\n")
        self.assertEqual(result.exit_code, 0)
