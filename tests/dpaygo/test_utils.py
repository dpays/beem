...
class Testcases(unittest.TestCase):
    ...
    def test_authorperm_resolve(self):
        self.assertEqual(resolve_authorperm('https://dvideo.io/#!/v/jared/m5cqkd1a'),
                         ('jared', 'm5cqkd1a'))
        self.assertEqual(resolve_authorperm("https://dsite.io/witness-category/@jared/24lfrm-jared-witness-log"),
                         ('jared', '24lfrm-jared-witness-log'))
        self.assertEqual(resolve_authorperm("@jared/24lfrm-jared-witness-log"),
                         ('jared', '24lfrm-jared-witness-log'))
        self.assertEqual(resolve_authorperm("https://busy.org/@jared/24lfrm-jared-witness-log"),
                         ('jared', '24lfrm-jared-witness-log'))
        self.assertEqual(resolve_authorperm('https://dlive.io/livestream/stan/61dd94c1-8ff3-11e8-976f-0242ac110003'),
                         ('stan', '61dd94c1-8ff3-11e8-976f-0242ac110003'))
    ...
    def test_authorpermvoter_resolve(self):
        self.assertEqual(resolve_authorpermvoter('theaussiegame/cryptokittie-giveaway-number-2|test'),
                         ('nomoreheroes', 'cryptokittie-giveaway-number-2', 'test'))
        self.assertEqual(resolve_authorpermvoter('lune/virtuelle-cloud-mining-ponzi-schemen-auch-bekannt-als-hypt|lune'),
                         ('cryptokong', 'virtuelle-cloud-mining-ponzi-schemen-auch-bekannt-als-hypt', 'lune'))
